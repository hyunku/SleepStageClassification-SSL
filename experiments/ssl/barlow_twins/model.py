...
if __name__ == '__main__':
    ...
    mo = BarlowTwins(backbone_name='BaseCNN',
                     backbone_parameter=get_backbone_parameter(model_name='BaseCNN', sampling_rate=100),
                     projection_size=256, projection_hidden=256)
    for _ in range(100):
        d1 = torch.randn(size=(128, 1, 3000))
        d2 = torch.randn(size=(128, 1, 3000))
        loss_ = mo((d1, d2))
        print(loss_)
        exit()