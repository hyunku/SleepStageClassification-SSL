...
from experiments.ssl.barlow_twins.data_loader import *
...
def get_args():
    ...
    parser.add_argument('--backbone_name', default='DeepSleepNet', type=str, choices=['DeepSleepNet', 'CNNEncoder2D'])
    parser.add_argument('--backbone_parameter', default=get_backbone_parameter(model_name='DeepSleepNet',
                                                                               sampling_rate=125))
    ...
    parser.add_argument('--ckpt_path', default=os.path.join('..', '..', '..', 'ckpt',
                                                            'SHHS', 'barlow_twins', 'DeepSleepNet'), type=str)
